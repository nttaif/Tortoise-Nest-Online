        ...
        <div className="flex flex-col lg:flex-row lg:space-x-10 space-y-10 lg:space-y-0">
          ...
          <div className="relative lg:col-span-2">
            ...
            <div className="p-6 bg-white rounded-b-lg">
              ...
              {/* Thông tin khóa học */}
              <h1 className="text-2xl font-bold mb-4">Không có thông tin</h1>
              ...
              <div className="flex items-center mb-6">
                ...
                <p className="text-gray-600 ml-2">
                  By ThaiLong • 24/07/2024 • 2,250 Học viên
                </p>
              </div>
            </div>
            <Tabs defaultValue="Overview">
              ...
              <TabsContent value="Overview" className="sm:w-full">
                ...
                <div className="flex sm:w-[1050px] mx-auto rounded-xl overflow-hidden bg-white p-6  border shadow-md duration-300 hover:shadow-lg transition-all">
              ...
              <TabsContent value="Reviews" className="sm:w-full">
                <SectionReviews />
              </TabsContent>
            </Tabs>
          </div>
          ...
          <div className="lg:top-0 lg:right-0 lg:w-1/3 w-full max-w-sm p-4 z-50">
