          ...
          >
            <div className="text-[#161439] flex place-content-center">
              <Image
                ...
                alt="Logo"
              />
              <p className="font-bold font-mono text-xl content-center text-center">
            ...
            <div
              id="search-bar"
              className="hidden xl:flex outline outline-[0.1px] rounded-3xl outline-black"
            >
                ...
                <div className="hidden lg:flex">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuItem
                        onClick={() => {
                          router.push(`/Admin/account/id/${session?.user?._id}`);
                        }}
                      >
                        Thông tin cá nhân
                      </DropdownMenuItem>
                      ...
                      session?.user?.role === "Admin" ? (
                        <DropdownMenuItem
                          onClick={() => {
                            router.push(`/Admin/dashboard/${session?.user?._id}`);
                          }}
                        >
