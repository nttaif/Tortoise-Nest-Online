      ...
      <div id='sticky-header' className='w-full'>
        <div className='container min-w-full flex justify-between items-center'>
          <nav id='header-form' className='w-full flex justify-between px-4 md:px-10 items-center'>
            <div className='text-[#161439] flex place-content-center'>
              <Image
                ...
                alt='Logo'
              />
              <p className='font-bold font-mono text-xl content-center text-center'>TORTOISE NEST ONLINE</p>              
            </div>
            ...
            <NavigationMenu className={`hidden lg:flex lg:items-center`} >
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className='text-black text-base font-bold hover:text-[#5751e1] '><a href='/'>Home</a> </NavigationMenuTrigger>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className='text-black text-base font-bold hover:text-[#5751e1]   ' >Courses</NavigationMenuTrigger>
                  <NavigationMenuContent>
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger className='text-black text-base font-bold hover:text-[#5751e1]' >Page</NavigationMenuTrigger>
                   <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger className='text-black text-base font-bold hover:text-[#5751e1] ' >Dashboard</NavigationMenuTrigger>
                   <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                  ...
                  <div className='flex items-center pl-4 '>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button className='text-black text-base h-12' variant="ghost">
                          Categories
