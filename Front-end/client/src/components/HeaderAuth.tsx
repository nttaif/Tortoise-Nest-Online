  ...
  const dropdownContents = {
    ...
    Courses: (
      <>
        ...
        <DropdownMenuRadioGroup>
          <DropdownMenuRadioItem value="course1">
            <a href="" className="block w-full h-full">
              Course 1
            </a>
          </DropdownMenuRadioItem>
          <DropdownMenuRadioItem value="course2">
            <a href="" className="block w-full h-full">
              Course 2
            </a>
          </DropdownMenuRadioItem>
          <DropdownMenuRadioItem value="course3">
            <a href="" className="block w-full h-full">
              Course 3
            </a>
          </DropdownMenuRadioItem>
      ...
      <>
        ...
        <DropdownMenuRadioGroup>
          <DropdownMenuRadioItem value="about">
            <a href="/ThanhTai" className="block w-full h-full">
              About Us
            </a>
          </DropdownMenuRadioItem>
    ...
    <div className="h-16 w-full border-b-2 content-center text-center bg-white sticky top-0 z-50 ">
      <div id="sticky-header" className="w-full">
        <div className="container min-w-full flex justify-between items-center">
          <nav
            id="header-form"
            className="w-full flex justify-between px-4 md:px-10 items-center"
          >
            {/* Logo */}
            ...
            <div className={`hidden lg:flex lg:items-center`}>
              <ul className="flex justify-between text-[#161439] space-x-6">
                {["Home", "Courses", "Pages", "Dashboard"].map(
                  (menuItem, index) => (
                    <li key={menuItem} className="flex items-center  ">
                      ...
                      >
                        ...
                        >
                          {
                            dropdownContents[
                              menuItem as keyof typeof dropdownContents
                            ]
                          }
                        </DropdownMenuContent>
                      </DropdownMenu>
            ...
            <div
              id="search-bar"
              className="hidden lg:flex outline outline-[0.1px] rounded-3xl outline-black"
            >
            ...
            {session ? (
              <div className="hidden lg:flex">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuLabel>{session?.user?.email ?? "null"}</DropdownMenuLabel>
                    <DropdownMenuSeparator />
          ...
          >
            ...
            <div className="p-6">
              ...
              <div
                id="mobile-search"
                className="flex justify-center outline outline-[0.1px] rounded-3xl outline-black mt-4"
              >
                <InputNoOutLine
